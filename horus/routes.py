...
def includeme(config):
    ...
    config.add_route('horus_activate', '/activate/{user_account_id}/{code}', factory=UserAccountFactory)
    config.add_route('horus_forgot_password', '/forgot_password')
    config.add_route('horus_reset_password', '/reset_password/{code}')
    config.add_route('horus_profile', '/profile/{user_account_id}', factory=UserAccountFactory,
            traverse="/{user_account_id}")
    config.add_route('horus_edit_profile', '/profile/{user_account_id}/edit',
            factory=UserAccountFactory, traverse="/{user_account_id}")
